class Shop:
    ...
    def get_sale_volume(self):
        """Get sale volume"""
        return self.sale_volume
...
while True:
    ...
    shop_info = Shop(name, type, operating_days, hours)

    volume = int(input("Enter sale volume: "))
    shop_info.volume_sold(volume)
