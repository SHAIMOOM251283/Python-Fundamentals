...
for shop in shops:
    ...
    print("Initial Sale Volume: ", volume)
    
    new_volume = int(input("Enter New Volume: "))
    shop.volume_sold(new_volume)
    print("New Sale Volume:", shop.sale_volume)
    
    increment_sale_volume = int(input("Incremented Sale Volume: "))
    shop.increment_volume_sold(increment_sale_volume)
    print("Updated Sale Volume:", shop.sale_volume)
